...
static const char qt_meta_stringdata_MyMainWin[] = {
    "MyMainWin\0\0load()\0showResolution()\0"
};
...
void MyMainWin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->showResolution(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData MyMainWin::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MyMainWin::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_MyMainWin,
      qt_meta_data_MyMainWin, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MyMainWin::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MyMainWin))
